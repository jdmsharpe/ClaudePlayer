...
- **AI-Powered Gameplay**: Uses Claude to analyze game frames and determine optimal actions
...
```json
{
  ...
  "MODEL_DEFAULTS": {
    ...
    "MAX_TOKENS": 16834,                 // Maximum tokens per response
    "THINKING_BUDGET": 11111,            // Budget tokens for thinking
  ...
  "MEMORY": {
    "MEMORY_INTERVAL": 25,               // Run memory agent every N turns
